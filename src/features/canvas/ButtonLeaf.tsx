...
export function ButtonLeaf({
  ...
  const variantClass = ({
    ...
    plain: "bg-transparent text-neutral-300 hover:text-neutral-100",
  } as Record<string, string>)[p.variant ?? "primary"] ?? "bg-sky-500 text-white hover:bg-sky-400";
  ...
  // fixed size가 지정된 경우 버튼 요소 자체에 직접 적용
